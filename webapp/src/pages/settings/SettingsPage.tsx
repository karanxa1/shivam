    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">Application information</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-muted-foreground">App Name</span>
            <span className="text-foreground font-medium">FinManager</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-muted-foreground">Version</span>
            <Badge variant="outline" className="border-border text-foreground">1.0.0</Badge>
          </div>
          <div className="flex items-center justify-between">
